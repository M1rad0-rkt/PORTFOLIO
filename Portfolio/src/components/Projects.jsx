...
export default function Projects({ darkMode }) {
  const projects = [
    ...
    },
    {
      ...
      description: 'Jeux qui invoque les années d"enfance et qui symbolise la guerre contre les aliens, il est nommé "AKTIFITIFITRA" ',
    ...
    },
    {
      ...
      description: 'Plateforme de réservation de lieux pour tout type d"évènement',
      image: '/rezerveo.jpg',
    ...
    {
      title: 'Chatbot IA',
      description: 'Chatbot intelligent utilisant le traitement du langage naturel pour répondre aux questions et fournir une assistance personnalisée.',
      image: '/coming.jpg',
    ...
    {
      title: 'Système intelligent de recommandation de lieux',
      description: 'Système de recommandation de lieux basé sur les préférences des utilisateurs et les données de localisation pour suggérer des destinations personnalisées.',
      image: '/coming.jpg',
